...
export default defineSchema({
  ...
  participants: defineTable({ roomId: v.id("rooms"), name: v.string(), agent: v.string(), tokenHash: v.string(), joinedAt: v.number() }).index("by_token_hash", ["tokenHash"]).index("by_room", ["roomId"]),
